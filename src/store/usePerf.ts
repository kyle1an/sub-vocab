...
export const useTimeStore = defineStore('timeStore', () => {
  ...
  function logPerf() {
    ...
    console.log('%c' + alignWord(' ╭╴ merge vocabulary', time.log.mergeEnded - time.log.mergeStarted,), 'color: gray; font-style: italic; padding: 0.1px');
    console.log('%c' + alignWord(' ╭╴ formLabel vocabulary', time.log.formLabelEnded - time.log.mergeEnded,), 'color: gray; font-style: italic; padding: 0.1px');
