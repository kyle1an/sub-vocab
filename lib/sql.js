...
call acquaint_word_record(get_vocab_id('${newVocab}'), get_user_id_by_name('${username}')) as row_count;
${checkValidityByUser(newVocab, username)}
`

module.exports.revokeWordByUser = (vocab, username) => `
call revoke_word_record(get_vocab_id('${vocab}'), get_user_id_by_name('${username}')) as row_count;
