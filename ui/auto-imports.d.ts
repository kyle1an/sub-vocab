...
declare global {
  ...
  const HeaderTitle: typeof import('./src/components/ui/table-element')['HeaderTitle']
  ...
  const TextareaInput: typeof import('./src/components/ui/textarea-input')['TextareaInput']
