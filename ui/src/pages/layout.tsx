...
export default function RootLayout() {
  ...
  return (
    <div
      ref={ref}
      className="isolate flex h-full min-h-full flex-col bg-[--theme-bg] pr-[--pr] antialiased sq-smooth-[0.6] sq-radius-[5_5_0_0] sq-fill-[red] [--b-g:var(--theme-bg)] sq:[corner-shape:superellipse(3)]"
      data-vaul-drawer-wrapper=""
    >
      <TopBar />
      <div className="flex min-h-svh flex-col items-center pt-11 z-0">
        <Outlet />
      </div>
      <Toaster
        closeButton
