...
export function VocabularyPage() {
  ...
  return (
    <div className="h-full pb-7">
      ...
      <SquircleBg className="m-auto flex h-[calc(100vh-4px*36)] max-w-full items-center justify-center overflow-hidden rounded-xl border-[length:--l-w] sq-outline-[--l-w] sq-stroke-[hsl(var(--border))] sq-fill-transparent [--l-w:1px] [--sq-r:9px] md:h-[calc(100%-4px*14)]">
