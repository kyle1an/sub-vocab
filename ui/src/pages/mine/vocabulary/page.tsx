...
export default function VocabularyPage() {
  ...
  return (
    <div className="h-full pb-7">
      ...
      <div className="m-auto flex h-[calc(100vh-4px*36)] max-w-full items-center justify-center overflow-hidden rounded-xl sq:rounded-3xl border [corner-shape:squircle] md:h-[calc(100%-4px*14)]">
