...
export default function ResizeVocabularyPanel() {
  ...
  return (
    (
      <div className="flex h-[calc(100%-4px*14)] items-center justify-center overflow-hidden rounded-xl sq:rounded-3xl border drop-shadow-sm [corner-shape:squircle]">
        <>
          <ResizablePanelGroup
            ref={panelGroupRef}
            direction={direction}
