  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-muted hover:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-accent data-[state=on]:text-accent-foreground',
  {
    variants: {
      variant: {
        ...
        outline: cn(
          'border border-input shadow-sm squircle sq-radius-[--sq-r] sq-outline sq-stroke-[hsl(var(--input))] sq-fill-transparent [--sq-r:6] hover:sq-fill-[hsl(var(--muted))] data-[state=on]:sq-fill-[hsl(var(--accent))] sq:border-none sq:shadow-none sq:drop-shadow-sm hover:sq:bg-transparent data-[state=on]:sq:bg-transparent',
          'relative [--offset:1px] focus-visible:after:squircle focus-visible:after:sq-radius-[calc(var(--sq-r)+var(--offset))] focus-visible:after:sq-outline focus-visible:after:sq-stroke-[hsl(var(--ring))] focus-visible:after:sq-fill-transparent sq:focus-visible:ring-0 sq:focus-visible:after:absolute sq:focus-visible:after:-left-[--offset] sq:focus-visible:after:-top-[--offset] sq:focus-visible:after:size-[calc(100%+2*var(--offset))]',
        ),
      },
      size: {
