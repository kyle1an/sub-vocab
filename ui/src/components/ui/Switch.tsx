  ...
  return (
    <div>
      <label className="group/label flex cursor-pointer justify-center [--squircle-circle-smooth:0.14]">
        ...
        />
        <div className="group/d relative inline-block h-[--sw-h] w-[--sw-w] select-none overflow-hidden rounded-[23px] bg-neutral-200 align-text-bottom transition-all duration-300 ease-linear sq-smooth-x-[.14] sq-smooth-y-[.8] sq-radius-full sq-radius-y-[8.4] sq-fill-[red] [--sw-h:26px] [--sw-w:46px] *:absolute *:rounded-full peer-checked:bg-[rgb(52,199,89)] peer-checked:*:right-[18px] sq:rounded-none sq:[mask:paint(squircle)] dark:bg-neutral-700">
