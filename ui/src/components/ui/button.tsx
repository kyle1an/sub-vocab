...
const buttonVariants = cva(
  clsx(
    'inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors [--offset:1px] [--sq-r:1rem] [corner-shape:squircle] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  ),
  {
    variants: {
      variant: {
