  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        ...
        'sq-radius-[--sq-r] [--sq-r:3px] focus:sq-outline-0 focus:sq-fill-[--accent] data-[highlighted]:sq-fill-[#6e56cf] focus:sq:bg-transparent focus:sq:[background:paint(squircle)] data-[highlighted]:sq:bg-transparent',
        className,
      )}
      {...props}
    >
