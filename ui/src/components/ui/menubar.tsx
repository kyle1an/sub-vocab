    ...
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          ...
          'before:squircle before:sq-rounded-[5px] before:sq-outline-0 before:sq-fill-popover sq:before:absolute sq:before:left-px sq:before:top-px sq:before:size-[calc(100%-2px)]',
          className,
        )}
        {...props}
      />
