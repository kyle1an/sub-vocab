    ...
    <div className={cn('flex w-[calc(28px+.1px)] justify-center', className)}>
      <button
        ...
        className={cn(
          ...
          phase === RETAINING && 'border-zinc-200/80 bg-amber-300/60 text-white duration-300 dark:border-zinc-600 dark:bg-amber-300/60 dark:text-white/60',
