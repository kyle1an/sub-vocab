    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          'squircle sq-rounded-[8px] sq-outline-[--line-w] sq-fill-border [--line-w:1px] sq:border-0 sq:bg-transparent sq:shadow-none sq:drop-shadow-lg sq:before:absolute sq:before:left-px sq:before:top-px sq:before:-z-10 sq:before:size-[calc(100%-2*var(--line-w))] sq:before:border-0',
          'before:squircle before:sq-rounded-[7px] before:sq-outline-0 before:sq-fill-background',
          className,
        )}
        {...props}
      />
