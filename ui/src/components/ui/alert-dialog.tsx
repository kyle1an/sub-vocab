    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          'squircle sq-rounded-[8px] sq-outline sq-fill-border sq:border-0 sq:bg-transparent sq:shadow-none sq:drop-shadow-lg sq:before:absolute sq:before:left-px sq:before:top-px sq:before:-z-10 sq:before:size-[calc(100%-2px)] sq:before:border-0',
