...
import type { Download } from '@/app/[locale]/subtitles/_api/os'
import type { tmdb } from '@sub-vocab/utils/types'

import { $osApi, openSubtitlesDownloadAtom, openSubtitlesTextAtom } from '@/app/[locale]/subtitles/_api/os'
import { $api } from '@/app/[locale]/subtitles/_api/tmdb'
import { fileIdsAtom, mediaSubtitleFamily, osLanguageAtom } from '@/app/[locale]/subtitles/_atoms'
import { MediaDetails } from '@/app/[locale]/subtitles/_components/media-details'
import { OpensubtitlesAuthentication } from '@/app/[locale]/subtitles/_components/opensubtitles-authentication'
