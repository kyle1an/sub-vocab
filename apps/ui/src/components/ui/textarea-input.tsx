...
export function TextareaInput({
  ...
  return (
    <Textarea
      ...
      className={cn(
        'size-full max-h-full resize-none rounded-none bg-background px-[30px] py-3 align-top outline-hidden focus-visible:ring-0 dark:bg-transparent dark:text-neutral-400 dark:placeholder:text-neutral-600',
        'border-0',
        className,
      )}
      onDrop={dropHandler}
